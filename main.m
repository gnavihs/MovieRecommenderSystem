...
fprintf('Visualizing the ratings matrix by plotting it with imagesc');
imagesc(Y);
ylabel('Movies');
xlabel('Users');
...
%  Before I train the collaborative filtering model, I will first
...
%% Recommendation for user by computing the predictions matrix.
%
